    ...
    <section id="wrapper" class="container">
        ...
        <section id="content" class="content">
            ...
            <header class="content-header">
                ...
                <h1 class="content-title">Create Page</h1>
            </header><!-- /side left -->
                    ...
                    <div class="content-app fixed-header">
                        ...
                        <div class="app-header">
                            ...
                            <ol class="breadcrumb bg-none pull-left hide-xs">
                                ...
                                <li><a href="<?php echo base_url(); ?>users/pages/list">Pages</a></li>
                                ...
                                <div id="wizard-1">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="username">Name of page*</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="password">Content</label>
                                           <div class="col-sm-9">
