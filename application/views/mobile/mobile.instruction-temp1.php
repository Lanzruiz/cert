    ...
    <div class="snap-drawers">
            ...
            <div class="sidebar-menu">
                ...
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item" href="features-interactive.html">   <i class="fa fa-angle-right"></i><em>   Interactive    </em><i class="fa fa-circle"></i></a>                    </div>
                </div>                 
                <div class="has-submenu">
        ...
        <div id="content" class="snap-content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->
                ...
                <div class="container">                   
                    <p>
                        Features ranging from notifications, to toggles and tabs, all made very easy to
                        use with simple copy and paste implementations! Documented for everyone to use 
                ...
                <div class="show-no-detection device-detected">
                    ...
                    <a href="#" class="button-small button-red button-center">Proceed to Personalization</a>
                </div>
