...
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>application/views/mobile/images/splash/android-chrome-192x192.png" sizes="192x192">
<link rel="apple-touch-icon" sizes="196x196" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-196x196.png">
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-180x180.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-152x152.png">
<link rel="apple-touch-icon" sizes="144x144" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-144x144.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-120x120.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-114x114.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-76x76.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="57x57" href="<?php echo base_url(); ?>application/views/mobile/images/splash/apple-touch-icon-57x57.png">  
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>application/views/mobile/images/splash/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>application/views/mobile/images/splash/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>application/views/mobile/images/splash/favicon-16x16.png" sizes="16x16">
<link rel="shortcut icon" href="<?php echo base_url(); ?>application/views/mobile/images/splash/favicon.ico" type="image/x-icon" /> 
    
<title>Epsilon 4.0</title>

<link href="<?php echo base_url(); ?>application/views/mobile/styles/style.css"           rel="stylesheet" type="text/css">
<link href="<?php echo base_url(); ?>application/views/mobile/styles/framework.css"       rel="stylesheet" type="text/css">
<link href="<?php echo base_url(); ?>application/views/mobile/styles/font-awesome.css"    rel="stylesheet" type="text/css">
<link href="<?php echo base_url(); ?>application/views/mobile/styles/animate.css"         rel="stylesheet" type="text/css">

<script type="text/javascript" src="<?php echo base_url(); ?>application/views/mobile/scripts/jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>application/views/mobile/scripts/jqueryui.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>application/views/mobile/scripts/framework-plugins.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>application/views/mobile/scripts/custom.js"></script>
</head>
...
<div id="header-fixed" class="header-style-1">
    ...
    <a class="header-logo" href="#"><img src="<?php echo base_url(); ?>application/views/mobile/images/logo-dark2.png" alt="img"></a>
    ...
    <div class="snap-drawers">
        <div class="snap-drawer snap-drawer-left">        
            <div class="sidebar-header-left">
                <a href="#"><img src="<?php echo base_url(); ?>application/views/mobile/images/logo-dark2.png" alt="img"></a>
            ...
            <div class="sidebar-menu">
                <a class="menu-item menu-item-active" href="index.html">
                ...
                <div class="has-submenu">
                    ...
                    <div class="submenu">
                        <a class="submenu-item" href="menu-left.html">     <i class="fa fa-angle-right"></i><em>   Left Sidebar    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="menu-right.html">    <i class="fa fa-angle-right"></i><em>   Right Sidebar    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="menu-dual.html">     <i class="fa fa-angle-right"></i><em>   Dual Sidebar    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="menu-top.html">      <i class="fa fa-angle-right"></i><em>   Top Menu    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="menu-bottom.html">   <i class="fa fa-angle-right"></i><em>   Bottom  Menu    </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>              
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="gallery-square.html">         <i class="fa fa-angle-right"></i><em>   Square    </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            ...
            <!--Page content goes here, fixed elements go above the all elements class-->
                ...
                <div class="gallery square-thumbs">
                    <a href="<?php echo base_url(); ?>application/views/mobile/images/pictures/1.jpg"><img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/myplan.png" alt="img"></a>                    
                    <a href="<?php echo base_url(); ?>application/views/mobile/images/pictures/2.jpg"><img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/preparednessinfo.png" alt="img"></a>                    
                    <a href="<?php echo base_url(); ?>application/views/mobile/images/pictures/3.jpg"><img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/disasterinfo.png" alt="img"></a>                    
                    <a href="<?php echo base_url(); ?>application/views/mobile/images/pictures/4.jpg"><img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/localinfo.png" alt="img"></a>                    
                    <a href="<?php echo base_url(); ?>application/views/mobile/images/pictures/5.jpg"><img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/localinfoconnection.png" alt="img"></a>                    
