            ...
            <div class="sidebar-menu">
                ...
                <div>
                    ...
                    <div class="submenu">
                        ...
                        <a class="submenu-item" href="page-reviews.html">   <i class="fa fa-angle-right"></i><em>   Userlist    </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>
                <div class="has-submenu">
                    <a class="menu-item show-submenu" href="#">
                ...
                <div class="portfolio-filter">
                    ...
                    <div class="portfolio-filter-wrapper">
                        <div class="cat1 all-cat gallery-filter-item">
                            <a class="show-gallery-1" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/1.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/1s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>                        
                        <div class="cat2 all-cat gallery-filter-item">
                            <a class="show-gallery-2" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/2.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/2s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>                        
                        <div class="cat3 all-cat gallery-filter-item">
                            <a class="show-gallery-3" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/3.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/3s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>                        
                        <div class="cat1 all-cat gallery-filter-item">
                            <a class="show-gallery-1" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/4.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/4s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>                        
                        <div class="cat2 all-cat gallery-filter-item">
                            <a class="show-gallery-2" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/5.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/5s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>                        
                        <div class="cat3 all-cat gallery-filter-item">
                            <a class="show-gallery-3" href="<?php echo base_url(); ?>application/views/mobile/images/pictures/6.jpg">
                                <img src="<?php echo base_url(); ?>application/views/mobile/images/pictures/6s.jpg" class="responsive-image" alt="img">
                            </a>                        
                        </div>   
                    </div>
                </div>
