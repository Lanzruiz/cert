...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="box">
            ...
            <?php echo form_open('systems/process/user/signup?steps=1'); ?>
            <div class="content-wrap">
                <h6>Your Email is exist</h6>
                <input class="form-control" type="text" name="email" value="<?php echo $email; ?>" placeholder="E-mail address">
               
              
                <button class="btn-glow primary login">Enter</button>
