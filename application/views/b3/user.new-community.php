        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    <li><a href="<?php echo base_url(); ?>users/pages/listcommunity">list</a></li>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="new-user">
            <div class="row header">
                <div class="col-md-12">
                    <h3>Create a new community apps</h3>
                </div>                
            </div>
                ...
                <div class="col-md-9 with-sidebar">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label for="inputName1" class="col-md-2 control-label">Community Name</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="com_name" id="inputName1" placeholder="Name">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="inputAddress1" class="col-md-2 control-label">State</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
                              <button type="submit" class="btn btn-default">Create Apps</button>
                            </div>
                        </div>
                    </form>
