...
<body>
    ...
    <header class="navbar navbar-inverse" role="banner">
        ...
        <ul class="nav navbar-nav pull-right hidden-xs">
            ...
            <li class="settings hidden-xs hidden-sm">
                <a href="<?php echo base_url(); ?>systems/process/user/logout" role="button">
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo base_url(); ?>users/pages/addpreparednessinfo">Add New</a></li>
                </ul>
            </li>
            <li>
            ...
            <!-- statistics chart built with jQuery Flot -->
             ...
             <div class="row ctrls" style="margin-top:30px; margin-left: 24px">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#users">List Areas</a></li>
                    ...
                    <div class="tab-pane" id="users">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th tabindex="0" rowspan="1" colspan="1">No. Joined
                                </th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="1">No. Joined</th>
