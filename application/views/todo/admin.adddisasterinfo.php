       ...
       <header class="header bg-black navbar navbar-inverse">
        ...
        <section class="scrollable wrapper">
          <header class="header">
              <div class="row b-b">
                <div class="col-sm-8">
                  <h3 class="m-t m-b-none">Add Disaster Info</h3>
                  <p class="block text-muted">Welcome to application</p>
                </div>
                <div class="col-sm-4">
                 <div class="clearfix m-t-lg m-b-sm pull-right pull-none-xs">
                    <div class="pull-left">                  
                      <a href="<?php echo base_url(); ?>/admin/addresources" class="btn btn-s-md btn-success">Create New Disaster Info</a>
                    </div>
            ...
            <section class="tab-pane active" id="wizard">
              <div class="panel">
                <div class="wizard clearfix" id="form-wizard">
                  <ul class="steps">
                    <li data-target="#step1" class="active"><span class="badge badge-info">1</span>Disaster Name</li>
                    <li data-target="#step2"><span class="badge">2</span>Before</li>
                    <li data-target="#step3"><span class="badge">3</span>During</li>
                    <li data-target="#step4"><span class="badge">4</span>After</li>
