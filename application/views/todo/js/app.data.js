$(document).ready(function() {
	...
	var $rows = $('#table_active tr');

	var $rows_draft = $('#table_draft tr');

	var $rows_trash = $('#table_trash tr');

	var $rows_kits = $('#table_kits tr');

	var $rows_resources = $('#table_resources tr');

	var $rows_disaster = $('#table_disaster tr');


	$('#search_disasterinfo').keyup(function() {
	    ...
	    $rows_disaster.show().filter(function() {
	...
	$('#search_activepage').keyup(function() {
	...
	$('#search_kits').keyup(function() {
	    
	    var val = '^(?=.*\\b' + $.trim($(this).val()).split(/\s+/).join('\\b)(?=.*\\b') + ').*$',
	        reg = RegExp(val, 'i'),
	        text;
	    
	    $rows_kits.show().filter(function() {
	        text = $(this).text().replace(/\s+/g, ' ');
	        return !reg.test(text);
	    }).hide();
	...
	$('#search_resources').keyup(function() {
	    ...
	    $rows_resources.show().filter(function() {
	        text = $(this).text().replace(/\s+/g, ' ');
	        return !reg.test(text);
	    }).hide();
	...
	$('#search_draft').keyup(function() {
	    ...
	    var val = '^(?=.*\\b' + $.trim($(this).val()).split(/\s+/).join('\\b)(?=.*\\b') + ').*$',
	     ...
	     $rows_draft.show().filter(function() {
	        text = $(this).text().replace(/\s+/g, ' ');
	        return !reg.test(text);
	    }).hide();
		...
		$('#search_trash').keyup(function() {
	    
	    var val = '^(?=.*\\b' + $.trim($(this).val()).split(/\s+/).join('\\b)(?=.*\\b') + ').*$',
	        reg = RegExp(val, 'i'),
	        text;
	
	     $rows_trash.show().filter(function() {
	        text = $(this).text().replace(/\s+/g, ' ');
	        return !reg.test(text);
	    }).hide();
	});
