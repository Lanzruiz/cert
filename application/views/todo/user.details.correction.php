              ...
              <div class="panel">
                <div class="wizard clearfix" id="form-wizard">
                  <ul class="steps">
                    ...
                    <li data-target="#step2"><span class="badge">2</span>Personal</li>
                    <li data-target="#step3"><span class="badge">3</span>Emergency Team</li>
                ...
                <div class="step-content">
                   <?php echo form_open('systems/process/user/signup?steps=2'); ?>
                    <div class="step-pane active margin-top-20" id="step1">
                     ...
                     ?>
                      <p>Email*</p>
                      <input type="text" class="form-control redborder" id="email" name="email" data-trigger="change"  placeholder="Please type the information">
                     ...
                     ?> 
                      ...
                      <input type="text" class="form-control redborder" data-type="password" name="password" data-trigger="change"  placeholder="Type the information">
                     ...
                     <?php
                      ...
                      ?>
                           ...
                           <p class="margin-top-20">Password*</p>
                      <input type="text" class="form-control" data-type="password" name="password" data-trigger="change" value="<?php echo $password; ?>">
                      <?php
                      }
                     ?>
                      ...
                      <div class="actions m-t">
                        <button type="button" class="btn btn-white btn-sm btn-prev" disabled="disabled" data-target="#form-wizard" data-wizard="previous">Prev</button>
                     ...
                     <div class="step-pane margin-top-20" id="step2">
                      ...
                      <input type="text" class="form-control" name="fname" data-trigger="change" placeholder="Type the information">

                       <p class="margin-top-20">Middle Name*</p>
                      <input type="text" class="form-control" name="mname" data-trigger="change" placeholder="Type the information">

                       <p class="margin-top-20">Last Name*</p>
                      <input type="text" class="form-control" name="lname" data-trigger="change" placeholder="Type the information">
                    ...
                    <div class="step-pane" id="step3">
                      ...
                      <input type="text" class="form-control" name="team" data-trigger="change" placeholder="Type the information">

                      <p class="margin-top-20">Code*</p>
                      <input type="text" class="form-control" data-trigger="change"  placeholder="Type the information">
                      ...
                      <div class="actions m-t">
                         <button type="button" class="btn btn-white btn-sm btn-prev" data-target="#form-wizard" data-wizard="previous">Prev</button>
                         <button type="button" class="btn btn-white btn-sm btn-next displaynone" data-target="#form-wizard" data-wizard="next" data-last="Finish">Next</button>
                        <input type="submit" class="btn btn-white btn-sm btn-next" value="Enter" name="">
                      </div>
