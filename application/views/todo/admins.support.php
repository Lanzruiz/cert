        ...
        <section class="scrollable" id="pjax-container">
          <section class="vbox flex">
            <header class="header">
              <div class="row b-b">
                <div class="col-sm-4">
                  <h3 class="m-t m-b-none">Support</h3>
                  <p class="block text-muted">Add admin people</p>
                </div>
                <div class="col-sm-8">
                      ...
                      <section class="vbox">
                        <header class="header bg-light dk">
                          <ul class="nav nav-tabs">
                            <li class="active"><a href="#active" data-toggle="tab">Tickets Reported</a></li>
                            <!--
                                        ...
                                        <table class="table table-striped b-t text-sm" id="table_active">
                                          <thead>
                                            <tr>
                                              ...
                                              <th class="th-sortable" data-toggle="class">Subscription Email
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group">
              <label for="recipient-name" class="form-control-label">Admin Level:</label>
