        ...
        <section class="scrollable wrapper">
          ...
          <section class="vbox flex">
            <header class="header">
              <div class="row b-b">
                <div class="col-sm-8">
                  <h3 class="m-t m-b-none">Add Kits</h3>
                  <p class="block text-muted">Welcome to application</p>
                </div>
                <div class="col-sm-4">
                 <div class="clearfix m-t-lg m-b-sm pull-right pull-none-xs">
                    <div class="pull-left">                  
                      <a href="#" class="btn btn-s-md btn-success" data-toggle="modal" data-target="#createAdmin">Save Kits</a>
                    </div>
             ...
             <section class="panel">
                      <header class="panel-heading bg-success">
                        <ul class="nav nav-tabs nav-justified text-uc">
                          <li class="active"><a href="#popular" data-toggle="tab">Add Resources</a></li>
                      ...
                      <div class="panel-body">
                        <div class="tab-content">
                          <div class="tab-pane active" id="popular">
                             ...
                             <div class="form-group">
                                <label for="recipient-name" class="form-control-label">Resources Name:</label>
