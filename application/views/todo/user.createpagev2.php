              ...
              <li>
               ...
               <li class="dropdown-submenu active">
                ...
                <ul class="dropdown-menu">                
                  <li>
                    <a href="<?php echo base_url(); ?>/users/pages">List Pages</a>                    
                  </li>
                  <li class="active">
          ...
          <section class="vbox flex">
            <header class="header">
              ...
              <div class="wrapper bg-light pull-in b-b font-bold">
                   ...
                   <input type="text" class="form-control" placeholder="Title of Page">
